"""hotel_review_analysis URL Configuration
...
from hotel_review_analysis import settings
...
urlpatterns = [
    ...
    url(r'^Hotel_Review_Analysis_Type/$', remoteuser.Hotel_Review_Analysis_Type, name="Hotel_Review_Analysis_Type"),
    ...
    url(r'^Find_Hotel_Review_Type_Ratio/$', serviceprovider.Find_Hotel_Review_Type_Ratio, name="Find_Hotel_Review_Type_Ratio"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^View_Hotel_Review_Type_Prediction/$', serviceprovider.View_Hotel_Review_Type_Prediction, name="View_Hotel_Review_Type_Prediction"),
